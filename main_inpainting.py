...
# path_folder = "Unrolling_comparison/DEQs/Inpainting/grad_lambda_Rtheta_" + str(lambda_Rtheta) + "_sigma_denoiser_" + str(sigma_denoiser) + "_sigma_noise_" + str(sigma_noise) + "_learnlambda_dc"
# os.makedirs(path_folder, exist_ok=True)
# On écrit les paramètres dans un fichier texte
# with open(os.path.join(path_folder, "params.txt"), "w") as f:
#     f.write(f"DC_type: {DC_type}\n")
#     f.write(f"lambda_Rtheta: {lambda_Rtheta}\n")
#     f.write(f"sigma_denoiser: {sigma_denoiser}\n")
